...
class Principal {
  ...
  toText() {
    ...
    const matches2 = result.match(/.{1,5}/g);
    if (!matches2) {
      throw new Error();
    }
...
const Twitch = createLucideIcon("twitch", __iconNode$4);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border/30 pt-14 pb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-5 gap-8 mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-sm overflow-hidden glow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-xs tracking-widest text-foreground", children: "TEAM APEX" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-xs tracking-widest text-accent", children: "GAMING" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed max-w-xs", children: "Built for dominance. Competing at the highest level of professional esports since 2021." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 mt-5", children: socials.map(({ icon: Icon2, label, href }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href,
            "aria-label": label,
      ...
      Object.entries(footerLinks).map(([category, links]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs tracking-widest text-muted-foreground mb-4 uppercase", children: category }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-8 border-t border-border/20 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-mono text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center gap-2 text-center md:text-left", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground/60", children: "This is a fan-made website. Not affiliated with any official organization." })
      ] }),
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "nav",
      {
        className: `fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-background/90 backdrop-blur-md border-b border-border/40 shadow-elevation-1" : "bg-transparent"}`,
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              "data-ocid": "nav.logo",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-sm overflow-hidden glow-sm group-hover:glow-md transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: "/assets/generated/tag-logo-transparent.dim_120x120.png",
                    alt: "TAG Logo",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-tight", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-sm tracking-widest text-foreground group-hover:text-accent transition-colors duration-200", children: "TEAM APEX" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-xs tracking-widest text-accent", children: "GAMING" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden md:flex items-center gap-1", children: NAV_ITEMS.map((item) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `relative px-4 py-2 text-sm font-display font-medium tracking-wider transition-colors duration-200 bg-transparent border-0 ${isActive ? "text-accent" : "text-muted-foreground hover:text-foreground"}`,
                "data-ocid": `nav.${id}.link`,
                children: [
                  item.label,
                  isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 w-4 h-0.5 bg-accent rounded-full glow-sm" })
                ]
              }
            ) }, item.href);
          }) }),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `absolute top-0 left-0 h-full w-72 bg-card border-r border-border/40 shadow-elevation-2 transition-transform duration-300 ${mobileOpen ? "translate-x-0" : "-translate-x-full"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 border-b border-border/30 flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-sm tracking-widest text-accent", children: "TAG" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "p-4 space-y-1", children: NAV_ITEMS.map((item) => {
                  const id = item.href.replace("#", "");
                  const isActive = activeSection === id;
                  return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      onClick: () => handleNavClick(item.href),
                      className: `w-full text-left flex items-center px-4 py-3 rounded-sm text-sm font-display font-medium tracking-wider transition-colors duration-200 ${isActive ? "text-accent bg-accent/10 border border-accent/20" : "text-muted-foreground hover:text-foreground hover:bg-muted/30"}`,
...
const pillars = [
  {
    icon: Trophy,
    title: "Born to Win",
    description: "TAG was founded in 2021 with a single purpose: to compete at the highest level of esports. From our first LAN event to international stages, every step has been driven by relentless determination."
  },
  {
    icon: Zap,
    title: "Elite Performance",
    description: "Our players train 10+ hours daily with dedicated coaches, analysts, and sports psychologists. We don't just play games — we build champions who perform under pressure when it matters most."
  },
  {
    icon: Globe,
    title: "Global Reach",
    description: "Representing athletes from Korea, Singapore, the US, Canada, and the UK, TAG brings together diverse perspectives and playstyles that make us unpredictable and unstoppable on the international stage."
  },
  {
    icon: Users,
    title: "Community First",
    description: "Our fans are the lifeblood of TAG. From Discord to live events, we invest in the community that built us — engaging, celebrating, and growing together as we chase every championship."
  }
];
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono tracking-[0.3em] text-accent mb-3", children: "OUR STORY" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl md:text-5xl tracking-tight text-foreground uppercase", children: "About TAG" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 mx-auto w-16 h-px bg-accent glow-sm" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(VisionStatement, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "mt-16 grid grid-cols-1 md:grid-cols-2 gap-5",
              "data-ocid": "about.pillars.list",
              children: pillars.map((pillar, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(PillarCard, { pillar, index: index2 }, pillar.title))
            }
          )
        ] })
      ]
...
function VisionStatement() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      ref,
      className: `relative glass-card rounded-sm p-8 md:p-12 text-center transition-all duration-700 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-95"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-1/2 -translate-x-1/2 w-24 h-px bg-accent glow-sm" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("blockquote", { className: "font-display font-bold text-2xl md:text-3xl lg:text-4xl text-foreground leading-tight tracking-tight max-w-3xl mx-auto", children: [
          `"We don't settle for `,
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent glow-accent", children: "second place." }),
          " Every match, every round, every single pixel — we play to ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent glow-accent", children: 'dominate."' })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-sm font-mono text-muted-foreground tracking-widest", children: "— TAG Leadership, 2021" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 w-24 h-px bg-accent glow-sm" })
      ]
    }
  );
}
function PillarCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      ref,
      className: `group glass-card rounded-sm p-6 transition-all duration-500 hover:glow-sm ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
      style: { transitionDelay: `${index2 * 80}ms` },
      "data-ocid": `about.pillars.item.${index2 + 1}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-10 h-10 rounded-sm bg-accent/15 border border-accent/20 flex items-center justify-center glow-sm group-hover:bg-accent/25 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 18, className: "text-accent" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-base text-foreground tracking-wide group-hover:text-accent transition-colors", children: pillar.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-2 leading-relaxed", children: pillar.description })
        ] })
      ] })
    }
  );
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              className: `text-center mb-16 transition-all duration-700 ${headingVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono tracking-[0.3em] text-accent mb-3", children: "GET IN TOUCH" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl md:text-5xl tracking-tight text-foreground uppercase", children: "Contact Us" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 mx-auto w-16 h-px bg-accent glow-sm" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-mono text-muted-foreground mb-6 tracking-wider uppercase", children: "Follow TAG" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "contact.social.list", children: socialLinks.map((social, index2) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    ...
                    "data-ocid": `contact.social.item.${index2 + 1}`,
                    target: "_blank",
                    rel: "noopener noreferrer",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-sm bg-accent/15 border border-accent/20 flex items-center justify-center glow-sm group-hover:bg-accent/30 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 16, className: "text-accent" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground", children: social.label }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-display font-medium text-foreground group-hover:text-accent transition-colors", children: social.handle })
                      ] })
                    ]
                  },
                  social.label
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              {
                ref: formRef,
                className: `glass-card rounded-sm p-8 transition-all duration-700 ${formVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-mono text-muted-foreground mb-6 tracking-wider uppercase", children: "Send a Message" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "form",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            ...
                            children: submitting ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "animate-pulse", children: "SENDING…" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
...
const highlights = [
  {
    ...
    description: "Marcus pulls off the impossible clutch in overtime to secure the map win.",
  ...
  },
  {
    ...
    description: "Sara opens the round with a devastating 4K AWP spray, setting TAG up for a flawless half.",
  ...
  },
  {
    ...
    description: "Full match recap of our dominant run through ESL Pro League Group A.",
...
function ContentSection() {
  const { ref: headingRef, isVisible: headingVisible } = useScrollReveal();
  const [activeVideo, setActiveVideo] = reactExports.useState(
    null
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              className: `text-center mb-16 transition-all duration-700 ${headingVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono tracking-[0.3em] text-accent mb-3", children: "WATCH & REWATCH" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl md:text-5xl tracking-tight text-foreground uppercase", children: "Highlights" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 mx-auto w-16 h-px bg-accent glow-sm" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(FeaturedHighlight, { highlight: highlights[0], onPlay: setActiveVideo }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "mt-6 grid grid-cols-1 md:grid-cols-2 gap-4",
              "data-ocid": "content.list",
              children: highlights.slice(1).map((h, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                SmallHighlight,
                {
                  highlight: h,
                  index: index2,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!activeVideo, onOpenChange: () => setActiveVideo(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          DialogContent,
          {
            className: "max-w-3xl bg-card border-border/40",
            "data-ocid": "content.video_dialog",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display font-bold tracking-wide text-foreground", children: activeVideo == null ? void 0 : activeVideo.title }) }),
              activeVideo && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-video rounded-sm overflow-hidden mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "iframe",
                {
...
function FeaturedHighlight({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
      ref,
      className: `group relative w-full text-left rounded-sm overflow-hidden cursor-pointer card-elevated transition-all duration-700 hover:glow-md ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-video relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-accent/90 flex items-center justify-center glow-md transition-smooth group-hover:scale-110 group-hover:bg-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Play,
            {
              size: 24,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 left-4 px-3 py-1 bg-accent/90 text-accent-foreground text-xs font-mono font-bold tracking-widest rounded-sm", children: "FEATURED" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg text-foreground group-hover:text-accent transition-colors", children: highlight.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: highlight.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mt-3 text-xs font-mono text-muted-foreground", children: [
...
function SmallHighlight({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
      ref,
      className: `group w-full text-left glass-card rounded-sm overflow-hidden cursor-pointer flex gap-0 transition-all duration-500 hover:glow-sm ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
      style: { transitionDelay: `${index2 * 80}ms` },
      onClick: () => onPlay(highlight),
      "data-ocid": `content.item.${index2 + 2}`,
      "aria-label": `Play ${highlight.title}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-40 flex-shrink-0 overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: highlight.thumbnail,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-background/40 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-accent/80 flex items-center justify-center transition-smooth group-hover:bg-accent group-hover:scale-110", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Play,
            {
              size: 14,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col justify-between min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-sm text-foreground group-hover:text-accent transition-colors line-clamp-2", children: highlight.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1 line-clamp-2", children: highlight.description })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-2 text-xs font-mono text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
...
function HeroSection() {
  ...
  const scrollToRoster = () => {
    var _a2;
    (_a2 = document.getElementById("roster")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(to top, oklch(var(--background)) 0%, transparent 100%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(to right, oklch(var(--background)) 0%, transparent 100%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(to left, oklch(var(--background)) 0%, transparent 100%)"
              }
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "repeating-linear-gradient(0deg, transparent, transparent 2px, oklch(var(--foreground)) 2px, oklch(var(--foreground)) 3px)",
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `inline-flex items-center gap-3 mb-8 transition-all duration-700 ${taglineVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`,
                  style: { transitionDelay: "100ms" },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-px w-12 bg-accent glow-sm" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono tracking-[0.4em] text-accent uppercase", children: "Professional Esports" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-px w-12 bg-accent glow-sm" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "h1",
                {
                  className: `font-display font-bold uppercase tracking-tight leading-none transition-all duration-700 ${taglineVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
                  style: { transitionDelay: "200ms" },
                  "data-ocid": "hero.heading",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-5xl sm:text-7xl md:text-8xl lg:text-9xl text-foreground", children: "TEAM APEX" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-5xl sm:text-7xl md:text-8xl lg:text-9xl text-accent glow-accent pulse-glow", children: "GAMING" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: `mt-6 text-base sm:text-lg md:text-xl font-body tracking-[0.2em] text-muted-foreground uppercase transition-all duration-700 ${taglineVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`,
                  style: { transitionDelay: "350ms" },
                  "data-ocid": "hero.tagline",
                  children: "Built for Dominance"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `mt-3 flex items-center justify-center gap-4 text-xs font-mono text-muted-foreground/60 tracking-widest transition-all duration-700 ${taglineVisible ? "opacity-100" : "opacity-0"}`,
                  style: { transitionDelay: "450ms" },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "TACTICAL" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent/60", children: "·" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 transition-all duration-700 ${taglineVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`,
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        onClick: () => {
                          var _a2;
                          return (_a2 = document.getElementById("matches")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
                        },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2 animate-bounce", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-muted-foreground/40 tracking-widest", children: "SCROLL" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { size: 16, className: "text-muted-foreground/40" })
        ] })
      ]
    }
  );
...
function MatchesSection() {
  const { ref: headingRef, isVisible: headingVisible } = useScrollReveal();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "matches", className: "py-24 bg-background relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref: headingRef,
        className: `text-center mb-16 transition-all duration-700 ${headingVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono tracking-[0.3em] text-accent mb-3", children: "SEASON RECORD" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl md:text-5xl tracking-tight text-foreground uppercase", children: "Recent Matches" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 mx-auto w-16 h-px bg-accent glow-sm" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(RecordBar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 space-y-3", "data-ocid": "matches.list", children: matches.map((match, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(MatchRow, { match, index: index2 }, match.id)) })
  ] }) });
}
function RecordBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-sm p-5 mb-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-bold text-2xl text-accent", children: [
            wins,
            "W"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground", children: "Wins" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-bold text-2xl text-muted-foreground", children: [
            losses,
            "L"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground", children: "Losses" })
        ] })
      ] }),
...
function MatchRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      ref,
      className: `relative group glass-card rounded-sm px-5 py-4 flex items-center gap-4 transition-all duration-500 hover:glow-sm ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-4"}`,
      style: { transitionDelay: `${index2 * 60}ms` },
      "data-ocid": `matches.item.${index2 + 1}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `flex-shrink-0 w-14 h-10 flex items-center justify-center rounded-sm font-display font-bold text-xs tracking-widest ${isWin ? "bg-accent/15 border border-accent/30 text-accent glow-sm" : "bg-muted/40 border border-border/30 text-muted-foreground"}`,
            children: isWin ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-bold text-sm tracking-wide text-foreground truncate", children: [
            "vs. ",
            match.opponent
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-mono truncate", children: match.tournament })
        ] }),
        match.map && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:flex items-center gap-1.5 text-xs text-muted-foreground font-mono", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 12 }),
          match.map
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-1.5 text-xs text-muted-foreground font-mono", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { size: 12 }),
          match.date
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `flex-shrink-0 font-display font-bold text-base tracking-widest ${isWin ? "text-accent" : "text-muted-foreground"}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `absolute left-0 top-0 bottom-0 w-0.5 rounded-r-full transition-all duration-300 ${isWin ? "bg-accent opacity-60 group-hover:opacity-100" : "bg-border/40"}`
          }
        )
      ]
    }
...
function RosterSection() {
  const { ref: headingRef, isVisible: headingVisible } = useScrollReveal();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "roster", className: "py-24 bg-muted/20 relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ref: headingRef,
          className: `text-center mb-16 transition-all duration-700 ${headingVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono tracking-[0.3em] text-accent mb-3", children: "THE LINEUP" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl md:text-5xl tracking-tight text-foreground uppercase", children: "Featured Players" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 mx-auto w-16 h-px bg-accent glow-sm" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: featuredPlayers.map((player, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(PlayerCard, { player, index: index2 }, player.id))
        }
      ),
      ...
      ].map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { stat, index: i }, stat.label)) })
    ] })
  ] });
}
function PlayerCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      ref,
      className: `group relative glass-card rounded-sm overflow-hidden cursor-pointer transition-all duration-500 hover:glow-md hover:-translate-y-1 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
      style: { transitionDelay: `${index2 * 80}ms` },
      "data-ocid": `roster.item.${index2 + 1}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[4/5] overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 h-0.5 bg-accent scale-x-0 group-hover:scale-x-100 transition-transform duration-300 glow-sm" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: player.role.toUpperCase()
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl tracking-wider text-foreground group-hover:text-accent transition-colors duration-200", children: player.handle }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: player.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 pt-3 border-t border-border/20 grid grid-cols-2 gap-2 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-mono", children: "K/D" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-sm text-foreground", children: player.kdRatio })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-mono", children: "WIN%" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-bold text-sm text-accent", children: [
                player.winRate,
                "%"
              ] })
            ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 right-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Badge,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Flag, { size: 10, className: "mr-1" }),
              player.country
            ]
          }
        ) })
...
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      ref,
      className: `glass-card rounded-sm p-5 text-center transition-all duration-500 hover:glow-sm ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`,
      style: { transitionDelay: `${index2 * 60}ms` },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-2xl text-accent glow-accent", children: stat.value }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground tracking-wider mt-1 uppercase", children: stat.label })
      ]
    }
  );
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(RosterSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MatchesSection, {}),
